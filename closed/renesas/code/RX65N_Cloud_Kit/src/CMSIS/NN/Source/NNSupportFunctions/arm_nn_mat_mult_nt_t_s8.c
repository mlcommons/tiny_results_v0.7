                                   ...
                                   const int32_t activation_max)
{
    ...
    for (int32_t rhs_rows_idx = 0; rhs_rows_idx <= (rhs_rows - 2); rhs_rows_idx += 2)
    {
        ...
        while (lhs_rows_idx)
        {
            ...
            res00 = __rmpab(res00, rhs_cols, (signed char *)lhs_ptr,(signed char *)rhs_ptr);
            lhs_ptr -= rhs_cols;
            res01 = __rmpab(res01, rhs_cols, (signed char *)lhs_ptr,(signed char *)rhs_ptr);
            rhs_ptr = rhs;
            res10 = __rmpab(res10, rhs_cols, (signed char *)lhs_ptr,(signed char *)rhs_ptr);
            lhs_ptr -= rhs_cols;
            res11 = __rmpab(res11, rhs_cols, (signed char *)lhs_ptr,(signed char *)rhs_ptr);
            ...
            asm inline ("mov.l %1, r1\n"
                        ...
                        "mov.l r1, %1\n"
                        "mov.l r2, %2\n"
                        : "+r" (res00), "+r" (lhs_ptr), "+r" (rhs_ptr)
                        : "r" (rhs_cols)
                        :  "r1", "r2", "r3", "r4", "r5", "r6", "cc", "memory");

            // rhs_ptr = rhs + rhs_cols;   // no need to calcurate
            lhs_ptr -= rhs_cols;
            ...
            asm inline ("mov.l %1, r1\n"
                        ...
                        "mov.l r1, %1\n"
                        "mov.l r2, %2\n"
                        : "+r" (res10), "+r" (lhs_ptr), "+r" (rhs_ptr)
                        : "r" (rhs_cols)
                        :  "r1", "r2", "r3", "r4", "r5", "r6", "cc", "memory");
            // rhs_ptr = rhs + rhs_cols;  // no need to calculate
            lhs_ptr -= rhs_cols;
        ...
        if (lhs_rows % 2)
        {
            ...
            asm inline ("mov.l %1, r1\n"
                        ...
                        : "r" (rhs_cols)
                        :  "r1", "r2", "r3", "r4", "r5", "r6", "cc", "memory");
            // rhs_ptr = rhs_ptr + rhs_cols; // no need to calcurate
            lhs_ptr -= rhs_cols;
