...
#define TH_VENDOR_NAME_STRING "NUCLEO_L4R5ZI"
#elif defined(TARGET_CY8CPROTO_062_4343W)
#define TH_VENDOR_NAME_STRING "CY8CPROTO_062_4343W"
#else
#define TH_VENDOR_NAME_STRING "undefined"
#endif

// Select the benchmark to run
#if defined(BENCHMARK_VWW)
#define TH_MODEL_VERSION EE_MODEL_VERSION_VWW01
constexpr int kInputSize = (96 * 96 * 3);
...
constexpr int kFeatureSliceSize = 128;
constexpr int kFeatureSliceCount = 5;
